...
const ENTRY_ANIMATIONS: { id: EntryAnimation; label: string }[] = [
  ...
  { id: "fly-in-left", label: "左の画面外から飛込" },
  { id: "fly-in-right", label: "右の画面外から飛込" },
  { id: "fly-in-up", label: "上の画面外から飛込" },
  { id: "fly-in-down", label: "下の画面外から飛込" },
...
const EXIT_ANIMATIONS: { id: ExitAnimation; label: string }[] = [
  ...
  { id: "fly-out-left", label: "左の画面外へ押出" },
  { id: "fly-out-right", label: "右の画面外へ押出" },
  { id: "fly-out-up", label: "上の画面外へ押出" },
  { id: "fly-out-down", label: "下の画面外へ押出" },
